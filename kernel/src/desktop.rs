...
fn describe_vm_error(error: vm::VmError) -> &'static str {
    match error {
        ...
        vm::VmError::UserProgramEmpty => "user program is empty",
        vm::VmError::UserProgramTooLarge => "user program exceeds supported address-space limits",
        vm::VmError::UserRegionConflict => "user virtual region conflicts with an existing mapping",
        vm::VmError::UserMappingConflict => "user page is already mapped or inaccessible",
        vm::VmError::UserEntryInvalid => "user entry point is outside executable bytes",
        vm::VmError::UserWritableExecutable => "user program contains a writable executable page",
        vm::VmError::UserPageTrackingCapacity => "user address-space page capacity exceeded",
        vm::VmError::ActiveAddressSpace => "cannot reclaim the active address space",
        vm::VmError::PageReclamationFailed => "physical page reclamation failed",
        vm::VmError::DirectMapUnavailable => "physical page is outside the kernel direct map",
        vm::VmError::ReservedRangeCapacity => "boot info cannot record more reserved ranges",
